...
I'm a passionate **DevOps Engineer** with expertise in **Kubernetes orchestration**, **CI/CD automation**, and **multi-cloud infrastructure**. Currently working at Devtron, I focus on building scalable, reliable systems that bridge the gap between development and operations.

- 🔭 Currently working on **Kubernetes orchestration** and **zero-downtime deployments**
- 🌱 Learning advanced **Go programming** and **AI-assisted development**
- 💡 Passionate about **cost optimization** and **performance tuning**
- 📍 Based in Gurugram, India
- ⚡ Fun fact: I've helped reduce cloud infrastructure costs by 40% through smart autoscaling!
...
![Crossplane](https://img.shields.io/badge/Crossplane-FF6B35?style=for-the-badge&logo=crossplane&logoColor=white)
